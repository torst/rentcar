                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Modifier Pays</h1>
                              <form class="cmxform form-horizontal" role="form" action="pays/actions_pays.php" id="modifier_pays" method="post"  >
                              <?php
							...
							$ligne=mysql_fetch_row($result);
                              ...
                              ?>
                                  ...
                                  <input type="hidden" name ="id_pays" value="<?php echo $ligne[0]; ?>" />
                                  <?php 
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="pays.php">Annuler</a>
