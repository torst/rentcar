                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
								...
								?>
                              <div class="btn-group">
                              <!--le lien est dans le fichier editable-table-villes.js dans l evenement onclick-->
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]; ?>">
                                  ...
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_villes"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="villes.php?action=detailler&&id_villes=<?php echo $ligne[0]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="villes.php?action=modifier&&id_villes=<?php echo $ligne[0]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
