...
<!--fin lockscreen-->
  <section id="container" class="">
      ...
      switch ( $action ) {
		  case 'lister':
		    include("locations/lister_locations.php");
		    break;
		  case 'ajouter':
		    include("locations/ajouter_locations.php");
		    break;
		  case 'modifier':
		    include("locations/modifier_locations.php");
		    break;
		  case 'detailler':
		    include("locations/detail_locations.php");
		    break;
		  default:
		    include("locations/lister_locations.php");
		}
    ...
    <script src="js/common-scripts.js"></script>
      <!--script for this page-->
	    <script src="js/locations/validation-form-locations.js"></script>
	    <script type="text/javascript" src="assets/bootstrap-fileupload/bootstrap-fileupload.js"></script>
	    <script src="js/locations/editable-table-locations.js"></script>
        <script type="text/javascript" src="assets/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
        <script type="text/javascript" src="js/locations/date-locations.js"></script>
