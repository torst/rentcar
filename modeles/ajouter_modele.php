                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <h1> Ajout d'un nouveau modèle</h1>
                              ...
                              ?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          ...
                                          ?>
										  <option value="<?php echo $ligne_marque[0]; ?>"><?php echo $ligne_marque[1]; ?></option>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          ...
                                          ?>
										  <option value="<?php echo $ligne_categorie[0]; ?>"><?php echo $ligne_categorie[1]; ?></option>
                                  ...
                                  <div class='form-group <?php if(strcmp($erreur_prix_court,"")!=0) echo " has-error";?>' >
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" value="<?php if(strcmp($prix_court,"")==0)  echo $prix_court; ?>" class="form-control" id="prix_court" name="prix_court" placeholder="Prix: ex 300, 300.00, 0 pour gratuit" >
                                  ...
                                  <div class='form-group <?php if(strcmp($erreur_prix_longue,"")!=0) echo " has-error";?>' >
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" value="<?php if(strcmp($prix_longue,"")==0)  echo $prix_longue; ?>" class="form-control" id="prix_longue" name="prix_longue" placeholder="Prix: ex 300, 300.00, 0 pour gratuit" >
                                  ...
                                  <div class='form-group ' >
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" value="" class="form-control" id="<?php echo $ligne_composant[0]; ?>" name="<?php echo 'val_car_'.$nb_caracteristiques; ?>" placeholder="<?php echo $ligne_composant[1]; ?>" >
