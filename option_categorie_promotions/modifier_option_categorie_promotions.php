                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Modifier la promotion - Option pour une catégorie</h1>
                              <form class="cmxform form-horizontal" role="form" action="option_categorie_promotions/actions_option_categorie_promotions.php" id="modifier_option_categorie_promotions" method="post"  >
                              <?php
