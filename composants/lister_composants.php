          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  <header class="panel-heading">
                      Liste des composants de modèle
                  </header>
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
								...
								?>
                              <div class="btn-group">
                              <!--le lien est dans le fichier editable-table-composants.js dans l evenement onclick-->
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]; ?>">
                                  ...
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_composant"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="composants.php?action=detailler&&id_composant=<?php echo $ligne[0]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="composants.php?action=modifier&&id_composant=<?php echo $ligne[0]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
