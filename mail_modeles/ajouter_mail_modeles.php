                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <h1> Ajout d'un modèle de message</h1>
                              <form class="cmxform form-horizontal" role="form" action="mail_modeles/actions_mail_modeles.php" id="modifier_mail_modeles" method="post"  enctype="multipart/form-data" nom="modifier_mail_modeles">
                              <?php
                              ...
                              ?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea class="form-control" id="corps" name="corps" placeholder="Corps du message ici" rows="13"><?php if(strcmp($erreur,"")==0) echo $corps; ?></textarea>
                                      </div>
                                  </div>
                                  
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="mail_modeles.php">Annuler</a>
