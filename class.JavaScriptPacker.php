 ...
 * 
 * This is the php version of the Dean Edwards JavaScripts Packer,
 * Based on :
 * 
 ...
 *   in fact preserve this order (but thats not require by the
...
class JavaScriptPacker {
    ...
    private function _analyze($script, $regexp, $encode) {
        ...
        if (!empty($all)) {
            ...
            // so the final packed script is different of the Deans javascript version
            // but equivalent.
    ...
    // Note : In Deans version, these functions are converted
...
class ParseMaster {
    ...
    // this is the global replace function (its quite complicated)
    ...
    // and we cannot use &$this in create_function, so lets go to lower level
    private $buffer;
