                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Modifier les informations de l'agence</h1>
							...
							$ligne=mysql_fetch_row($result);
                              ...
                              ?>
                                  ...
                                  <input type="hidden" name ="id_agence" value="<?php echo $ligne[0]; ?>" />
                                  <?php 
                                  ...
                                  <div class="form-group <?php if(strcmp($erreur_adresse,"")!=0) echo " has-error";?>">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea class="form-control" id="adresse" name="adresse" placeholder="Adresse" rows="3"><?php if(strcmp($erreur,"")==0) echo $ligne[2]; else echo $adresse; ?></textarea>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          ...
                                          ?>
										  <option 
										  <?php if ($ligne[6] == $ligne_ville[0]) echo "selected";?>
										  value="<?php echo $ligne_ville[0]; ?>"><?php echo $ligne_ville[1]; ?></option>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" value="<?php if(strcmp($erreur,"")==0) echo $ligne[3]; else echo $telephone; ?>" class="form-control" id="telephone" name="telephone" placeholder="Téléphone" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" value="<?php if(strcmp($erreur,"")==0) echo $ligne[4]; else echo $fax; ?>" class="form-control" id="fax" name="fax" placeholder="Fax" >
                                  ...
                                  <div class="form-group <?php if(strcmp($erreur_horaire,"")!=0) echo " has-error";?>">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea class="form-control" id="horaire" name="horaire" placeholder="Horaire : " rows="3"><?php if(strcmp($erreur,"")==0) echo $ligne[5]; else echo $horaire; ?></textarea>
