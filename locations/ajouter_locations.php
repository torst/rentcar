                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <div class="notice ">
    								<h4>Aide </h4>
    								<p>Le Montant calculé de la location est proposé à titre indicatif en tenant compte des données système (modèle véhicule, durée, options et services séléctionnés, promotions …). Vous avez la possibilité d'appliquer cette proposition ou bien de renseigner une nouvelle proposition dans le champ "Montant à payer".</p>
  								</div>
                              <form class="cmxform form-horizontal" role="form" action="locations/actions_locations.php" id="modifier_locations" method="post"  nom="modifier_locations">
                              <?php
                              include("config.php");
...
?>
                                  ...
                                  <div class="form-group <?php if(strcmp($erreur_vehicule,"")!=0) echo " has-error";?>">
                                      <label  class="col-lg-2 control-label">Véhicule</label>
                                      <div class="col-lg-6">
                                          <select name ="vehicule" id="vehicule"    placeholder="Sélectionner un véhicule..."></select>
                                      </div>
                                      <?php if(strcmp($erreur_vehicule,"")!=0) echo " <p class='help-block'>".$erreur_vehicule."</p>";?>
                                  </div>
                                ...
                                <div class="form-group last">
                                  ...
                                  <div class='form-group' >
                                      ...
                                      <div class="col-lg-6">
                                          ...
                                          <select class="form-control" name="statut_location" id="statut_location">
                                          <?php 
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="locations.php">Annuler</a>
