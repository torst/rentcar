                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Modifier les informations de la marque</h1>
                              <form class="cmxform form-horizontal" role="form" action="marques/actions_marque.php" id="modifier_marque" method="post"  enctype="multipart/form-data" nom="modifier_marque">
                              <?php
							...
							$ligne=mysql_fetch_row($result);
                              ...
                              ?>
                                  ...
                                  <input type="hidden" name ="id_marque" value="<?php echo $ligne[0]; ?>" />
                                  <?php 
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="controls col-md-9">
                                              <div class="fileupload fileupload-new" data-provides="fileupload" >
                                                ...
                                                <input type="file" class="default" name="marque" id="marque"/>
                                                </span>
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="marques.php">Annuler</a>
