                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
								...
								?>
                              <div class="btn-group">
                              <!--le lien est dans le fichier editable-table-clients.js dans l evenement onclick-->
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]; ?>">
                                  <td ><?php echo $ligne[1]." ".$ligne[2]; ?></td>
                                  <td ><a href="#" title="<?php echo $ligne[5]; ?>"><?php echo $ligne[3]; ?></a></td>
                                  <td ><?php echo $ligne[4]; ?></td>
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_clients"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="clients.php?action=detailler&&id_clients=<?php echo $ligne[0]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="clients.php?action=modifier&&id_clients=<?php echo $ligne[0]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
