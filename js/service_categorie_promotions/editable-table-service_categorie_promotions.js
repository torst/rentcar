...
//                editRow(oTable, nRow);
//                nEditing = nRow;
					location.href="service_categorie_promotions.php?action=ajouter";
            });
            ...
            $('#editable-sample a.delete').live('click', function (e) {
				...
				var id_service = tableau_ids[0];
				var id_categorie = tableau_ids[1];
				$.ajax({
					type: "POST",
					url: "service_categorie_promotions/actions_service_categorie_promotions.php",
					data: { id_service: id_service, id_categorie: id_categorie, option: "delete" }
					})
					.done(function( msg ) {
