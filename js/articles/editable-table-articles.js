    ...
    return {
        ...
        init: function () {
            ...
            var oTable = $('#editable-sample').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, -1],
                    [5, 15, 20, "Tous"] // change per article values here
                ],
                ...
                "oLanguage": {
                    "sLengthMenu": "_MENU_ lignes par article",
                    "oPaginate": {
                        "sPrevious": "Précedent",
                        "sNext": "Suivant"
                    }
            ...
            jQuery('#editable-sample_wrapper .dataTables_length select').addClass("form-control xsmall"); // modify table per article dropdown
...
//                editRow(oTable, nRow);
//                nEditing = nRow;
					location.href="articles.php?action=ajouter";
            });
            ...
            $('#editable-sample a.delete').live('click', function (e) {
				...
				$.ajax({
					type: "POST",
					url: "articles/actions_articles.php",
