...
//                editRow(oTable, nRow);
//                nEditing = nRow;
					location.href="option_categorie_promotions.php?action=ajouter";
            });
            ...
            $('#editable-sample a.delete').live('click', function (e) {
				...
				var id_option = tableau_ids[0];
				var id_categorie = tableau_ids[1];
				$.ajax({
					type: "POST",
					url: "option_categorie_promotions/actions_option_categorie_promotions.php",
					data: { id_option: id_option, id_categorie: id_categorie, option: "delete" }
					})
					.done(function( msg ) {
