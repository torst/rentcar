...
$("#modifier_locations").submit(function(e) {
	...
	//todo ajout validation nouveau champ
	 var idVehicule = $('#vehicule').val();

	//validate vehicule selectionne
	if (idVehicule == ""){
		e.preventDefault();
		alert('Prière de renseigner un matricule de véhicule');
		return;
	}
