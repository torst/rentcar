...
//                editRow(oTable, nRow);
//                nEditing = nRow;
					location.href="option_modele_promotions.php?action=ajouter";
            });
            ...
            $('#editable-sample a.delete').live('click', function (e) {
				...
				$.ajax({
					type: "POST",
					url: "option_modele_promotions/actions_option_modele_promotions.php",
					data: { id_option: id_option, id_modele: id_modele, option: "delete" }
					})
					.done(function( msg ) {
