...
//                editRow(oTable, nRow);
//                nEditing = nRow;
					location.href="service_modele_promotions.php?action=ajouter";
            });
            ...
            $('#editable-sample a.delete').live('click', function (e) {
				...
				$.ajax({
					type: "POST",
					url: "service_modele_promotions/actions_service_modele_promotions.php",
					data: { id_service: id_service, id_modele: id_modele, option: "delete" }
					})
					.done(function( msg ) {
