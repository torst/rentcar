                              ...
                              ?>
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="pages.php">Retour</a>
                                          <?php
												if(isset($_SESSION["modifier_page"])){ 
											?>
                                          <a  class=" btn btn-warning  " href="pages.php?action=modifier&&id_pages=<?php echo $ligne[0]; ?>">Modifier</a>
                                          <?php
												}
											?>
