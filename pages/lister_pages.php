                  ...
                  <div class="panel-body">
                      <div class="adv-table editable-table ">
                          <div class="clearfix">
								...
								?>
                              <div class="btn-group">
                              <!--le lien est dans le fichier editable-table-pages.js dans l evenement onclick-->
                              ...
                              <div class="btn-group pull-right">
                                  ...
                                  <ul class="dropdown-menu pull-right">
                                      ...
                                      <li><a href="pages/export.php?format=pdf" >Enregistrer PDF</a></li>
                                      <li><a href="pages/export.php?format=excel" >Exporter Excel</a></li>
                                  </ul>
                              </div>
                          </div>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]; ?>">
                                  ...
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_page"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="pages.php?action=detailler&&id_pages=<?php echo $ligne[0]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="pages.php?action=modifier&&id_pages=<?php echo $ligne[0]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
