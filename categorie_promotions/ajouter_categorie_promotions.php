                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <form class="cmxform form-horizontal" role="form" action="categorie_promotions/actions_categorie_promotions.php" id="modifier_categorie_promotions" method="post"  enctype="multipart/form-data" nom="modifier_categorie_promotions">
                              <?php
