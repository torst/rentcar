          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  <header class="panel-heading">
                      Liste des Catégories en promotion
                  </header>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]; ?>">
                                  ...
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_categorie_promotions"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="categorie_promotions.php?action=detailler&&id_categorie_promotions=<?php echo $ligne[0]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="categorie_promotions.php?action=modifier&&id_categorie_promotions=<?php echo $ligne[0]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
