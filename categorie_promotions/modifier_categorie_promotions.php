                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <form class="cmxform form-horizontal" role="form" action="categorie_promotions/actions_categorie_promotions.php" id="modifier_categorie_promotions" method="post"  >
                              <?php
                              ...
                              $categorie=utf8_encode($_GET['categorie']);
							...
							$ligne=mysql_fetch_row($result);
                              ...
                              ?>
                                  ...
                                  <input type="hidden" name ="id_categorie_promotions" value="<?php echo $ligne[0]; ?>" />
                                  <?php 
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="categorie_promotions.php">Annuler</a>
