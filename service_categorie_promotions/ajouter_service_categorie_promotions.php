                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <h1> Nouvelle promotion pour un service sur une catégorie</h1>
                              ...
                              <form class="cmxform form-horizontal" role="form" action="service_categorie_promotions/actions_service_categorie_promotions.php" id="modifier_service_categorie_promotions" method="post"  nom="modifier_service_categorie_promotions">
                              <?php
