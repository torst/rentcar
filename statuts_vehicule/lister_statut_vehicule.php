          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  ...
                  <header class="panel-heading">
                      Liste des statuts des véhicules
                  </header>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]; ?>">
                                  ...
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_statut_vehicule"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="statuts_vehicule.php?action=detailler&&id_statut_vehicule=<?php echo $ligne[0]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="statuts_vehicule.php?action=modifier&&id_statut_vehicule=<?php echo $ligne[0]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
