          ...
          <section class="wrapper">
              ...
              <section class="panel">
                  <header class="panel-heading">
                      Liste des options en promotion pour un modèle
                  </header>
                          ...
                          <table class="table table-striped table-hover table-bordered" id="editable-sample">
							...
							while($ligne=mysql_fetch_row($result)){
                              ...
                              <tr class="" id="<?php echo $ligne[0]."-".$ligne[1]; ?>">
                                  ...
                                  <td>
                                  <?php
										if(isset($_SESSION["zoom_option_modele_promotions"])){ 
									?>
                                  	<a id="detail" class=" btn btn-primary  btn-xs" href="option_modele_promotions.php?action=detailler&&id_option=<?php echo $ligne[0]; ?>&&id_modele=<?php echo $ligne[1]; ?>">
									...
									?>
                                  	<a id="remove-all" class=" btn btn-warning  btn-xs" href="option_modele_promotions.php?action=modifier&&id_option=<?php echo $ligne[0]; ?>&&id_modele=<?php echo $ligne[1]; ?>"><i class=" icon-edit"></i></a>
                                    <?php
										}
									?>
                                    <?php
