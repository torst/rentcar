                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <h1> Nouvelle promotion pour une option sur un modèle</h1>
                              <div class="notice ">
    								<h4>Important </h4>
                              ...
                              <form class="cmxform form-horizontal" role="form" action="option_modele_promotions/actions_option_modele_promotions.php" id="modifier_option_modele_promotions" method="post"  nom="modifier_option_modele_promotions">
                              <?php
