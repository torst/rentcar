                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <h1> Nouvelle promotion pour un service sur un modèle</h1>
                              <div class="notice ">
    								<h4>Important </h4>
                              ...
                              <form class="cmxform form-horizontal" role="form" action="service_modele_promotions/actions_service_modele_promotions.php" id="modifier_service_modele_promotions" method="post"  nom="modifier_service_modele_promotions">
                              <?php
                              ...
                              ?>
                                  ...
                                  <div class="form-group">
                                      <div class="col-lg-offset-2 col-lg-10">
                                      	  <a  class=" btn btn-primary  " href="service_modele_promotions.php">Annuler</a>
