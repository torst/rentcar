                  ...
                  <aside class="profile-info col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Modifier la promotion - Service pour un Modèle</h1>
                              <form class="cmxform form-horizontal" role="form" action="service_modele_promotions/actions_service_modele_promotions.php" id="modifier_service_modele_promotions" method="post"  >
                              <?php
